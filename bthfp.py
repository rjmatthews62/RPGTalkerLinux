    ...
    def _find_channel(self):
        ...
        for svc in services:
            ...
            for c in svc["service-classes"]:
                ...
                logging.info("Service class="+str(service_class)+":"+str(bluetooth.HANDSFREE_CLASS.lower()))
...
def main(args):
    ...
    if args[1] == 'scan':
        ...
        return
    if not bluetooth.is_valid_address(args[1]):
        print("Wrong device address.")
        return
    hf = BluetoothAudio(args[1], BluetoothAudio.AUDIO_16KHZ_SIGNED_16BIT_LE_MONO)
